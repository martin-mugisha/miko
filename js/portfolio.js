(function ($) {
  ...
  var galleries = {
    ...
    eye: numbered("EYE SANTE", ".", [1, 2, 3, 4, 5], "png").concat(whatsapp("EYE SANTE", "2026-06-29", ["13.28.06", "13.28.07", "13.28.08"])),
    ...
    sightsavers: whatsapp("sight savers", "2026-06-29", ["12.57.34"])
  };
  ...
  $(".project-gallery-trigger").on("click", function (event) {
    ...
    function openGallery() {
      $.magnificPopup.open({
        items: validImages.map(function (src) { return { src: src }; }),
        type: "image",
